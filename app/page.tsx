...
export default function Home() {
  ...
  \nLo siguiente no se como expressarlo sin sonar muy cliché o cursi 😅, pero quería comentarte que, a pesar de que hacía tiempo no conversábamos, la paso bien chévere contigo cuando jugamos. Tienes buena vibra, o al menos eso es lo que percibo. Si estás libre y no te incomoda, quisiera acercarme un poco más a ti. Aunque soy penoso, no muy bueno en COD, pero por lo menos me defiendo, jeje..
